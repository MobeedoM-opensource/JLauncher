...
public final class SettingsProvider {
    ...
    public static final String SETTINGS_UI_USE_EXTERNAL_DRAWER = "ui_external_drawer";
    public static final String SETTINGS_EXTERNAL_DRAWER_URI = "external_drawer_componenent";
