...
public class LauncherFiles {
    ...
    public static final String WALLPAPER_CROP_PREFERENCES_KEY = BuildConfig.APPLICATION_ID + ".WallpaperCropActivity";
    public static final String MANAGED_USER_PREFERENCES_KEY = BuildConfig.APPLICATION_ID + ".managedusers.prefs";
